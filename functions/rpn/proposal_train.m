...
% inputs
    ...
    ip.addParamValue('solver_def_file',     fullfile(imdb_train{1, 1}.details.root_dir, 'proposal_models', 'Zeiler_conv5', 'solver.prototxt'), ...
                                                        @isstr);
    ip.addParamValue('net_file',            fullfile(imdb_train{1, 1}.details.root_dir, 'proposal_models', 'Zeiler_conv5', 'Zeiler_conv5.caffemodel'), ...
                                                        @isstr);
...
%% try to find trained model
    ...
    cache_dir = fullfile(imdb_train{1, 1}.details.root_dir, 'output', 'rpn_cachedir', opts.cache_name, imdbs_name);
